...
public class BorrowerIdentityService {
    ...
    public BorrowerProfile resolveOrCreateAt(String borrowerName,
        ...
        List<BorrowerProfile> candidates = repository.findByNormalizedName(normalizedName).stream()
                .filter(profile -> optionalIdentityCompatible(normalizedGender, profile.getGenderNormalized()))
    ...
    private static boolean optionalIdentityCompatible(String observed, String stored) {
        return observed == null || stored == null || Objects.equals(observed, stored);
    }
}
