...
public class BorrowerEvaluationService {
    ...
    /**
     * Evaluates a borrower against a single predefined rule by its exact name and persists
     * the same snapshot/evaluation/audit trail as the general evaluation endpoint.
     */
    @Transactional
